...
# D3 all - scrape ALL shops (self + competitors), one sweep. Separate from the scheduled Hermes.
# Run:  powershell -ExecutionPolicy Bypass -File C:\D3\scripts\windows\start-self.ps1
# Or double-click C:\D3\D3 all.bat
...
Write-Host "[D3 all] Scraping ALL shops (self + A/B/C) now..." -ForegroundColor Cyan
& $node.Source .\src\sweep-all.mjs
